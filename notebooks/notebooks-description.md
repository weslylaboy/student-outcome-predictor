...
| **3** | `03_classification_model.ipynb` | `X_processed.csv`, `y_class.csv` | `model_classifier.joblib` - Trained classification model object. | Predicting student dropout risk. |
| **4** | `04_regression_model.ipynb`     | `X_processed.csv`, `y_gpa.csv` | `model_regressor.joblib` - Trained regression model object. | Predicting GPA and identifying risk factors. |